A full format on the data partition (to EXT4) plus disabling all lockscreen security options (just use "Swipe") is required before updating or you'll see "Error 7" in TWRP.
